    ...
    <div class="<?php if (isset($_GET['id'])) {
        ...
        <div class="row">
            ...
            <div class="col-sm-7    ">
                ...
                <div class="mb-3 position-relative"><label class="form-label" for="formGroupInputSmall"><strong>Razon Social</strong></label>
                    <input class="form-control margencaja" type="text" id="formGroupInputSmall" placeholder="Escribe" value="<?php if (empty($Clientesx)) {
                                                                                                                                    echo $Clientesx = "";
                                                                                                                                } else {
        ...
        <div class="row">
            ...
            <div class="col-sm-7    ">
                ...
                <div class="mb-3 position-relative"><label class="form-label" for="formGroupInputSmall"><strong>Numero de documento</strong></label>
                    <input maxlength="11" class="form-control margencaja" type="text" id="formGroupInputSmall" placeholder="Escribe" value="<?php if (empty($Clientesx)) {
                                                                                                                                    echo $Clientesx = "";
                                                                                                                                } else {
                    ...
                    <tbody>
                        <?php foreach ($clientes as $indice => $valor) : ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="incio.php?paginas=ActualizarCliente&id=<?php echo $valor['IdCliente']; ?>" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a>
                                    </div>
                                </td>
                            </tr>
                        <?php endforeach; ?>
...
<?php
            ...
            if ($ActualizarCliente == "ok") {
                ...
                echo "<script>
                        ...
                        echo "<script>  setTimeout(function(){window.location='incio.php?paginas=ActualizarCliente';}, 2000);</script>";
