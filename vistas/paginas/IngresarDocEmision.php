...
<form class="needs-validation" method="POST" novalidate>
  ...
  <p style="font-size:25px;" class="bg-dark text-white text-center">.: Agregar Documento de Emision :.</p>
    <div class=" row">
      <div class="col-sm-3 ">
      </div>
      <div class="col-sm-6 ">
        ...
        <div class="mb-3 position-relative"><label class="form-label" for="formGroupInputSmall"><strong>Documento de Emision</strong></label>
          <input onKeyUP="this.value=this.value.toUpperCase();" class="form-control margencaja" type="text" id="formGroupInputSmall" placeholder="Escriba" name="txtemisionagregar" onkeypress="return sololetras(event)" onpaste="return false" required>
          <!--  -->
    ...
    <div class="row">
      ...
      <div class="col-sm-2">
        ...
        <div class="d-grid gap-2 col-8 mx-auto">
          ...
          <button type="submit" class="btn btn-primary" name="btnagregaremision">Guardar</button>
        </div>
        <br>
...
<?php
$guardaremision = clsControlArrayEmision::medControlArrayEmision();
if ($guardaremision == "ok") {
