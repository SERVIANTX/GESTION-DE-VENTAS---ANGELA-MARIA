...
<div style="background-color: #fffbf4;">
            <p style="font-size:25px;" class="bg-dark text-white text-center">.: REPORTE DE PROVEEDORES :.</p>
<div class="row">
    ...
    <div class=" col-10 ">
        ...
        <div class="container">
            <?php
             $proveedores = clsControlArrayListProveedor::medSeleccionarProveedor();
            ?>
            ...
            <table id="datatablesSimple" class="table table-dark table-striped">
                ...
                <tbody>
                    <?php foreach ($proveedores as $indice => $valor): ?>
                    <tr>
    ...
    <div class="col-2 ">
        ...
        <div class="d-grid gap-2 col-8 mx-auto">
            ...
            <a href="paginas/ReporteProveedorespdf.php" target="_blank">
