...
<form class="needs-validation" method="POST" novalidate>
  ...
  <div style="background-color: #fffbf4; width:650px;height:390px; margin-left: auto; margin-right:auto;">
    <p style="font-size:25px;" class="bg-dark text-white text-center">.: Agregar Cliente :.</p>
    <div class="row">
      <div class="col-sm-3 ">
      ...
      <div class="col-sm-6 ">
        ...
        <br>
        <div class="mb-2 position-relative"><label class="form-label" for="formGroupInputSmall"><strong>Cliente</strong></label>
          <input onKeyUP="this.value=this.value.toUpperCase();" class="form-control " type="text" id="formGroupInputSmall" placeholder="Escribe" name="txtrazonsocial" onkeypress="return sololetras(event)" onpaste="return false" required>
          <!--  -->
    ...
    <div class="row">
      ...
      <div class="col-sm-6 ">
        ...
        <div class="mb-3 position-relative"><label class="form-label" for="formGroupInputSmall"><strong>Direccion</strong></label>
          <input  onKeyUP="this.value=this.value.toUpperCase();" class="form-control " type="text" id="formGroupInputSmall" placeholder="Escribe" name="txtdireccioncliente" required>
          <!--  -->
          <div class="invalid-tooltip">Complete los datos</div>
          <!--  -->
        </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-6 ">
        ...
        <div class="mb-3 position-relative"><label class="form-label" for="formGroupInputSmall"><strong>Numero de documento</strong></label>
          <input maxlength="11" class="form-control " type="text" id="formGroupInputSmall" placeholder="Escribe" name="txtruccliente" onkeypress="return solonumeros(event)" onpaste="return false" required>
          <!--  -->
          <div class="invalid-tooltip">Complete los datos</div>
          <!--  -->
        </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-2">
        <div class="d-grid gap-2 col-8 mx-auto">
          <button type="submit" class="btn btn-primary" name="btnGuardarventaCliente">Guardar</button>
        </div>
        <br>
        <br>
...
<?php
$guardarcliente = clsControlArrayCliente::medControlArrayCliente();
if ($guardarcliente == "ok") {
  echo "<script>swal('Felicidades!', 'Cliente Registrado', 'success');</script>";
  echo "<script>  setTimeout(function(){window.location='incioVendedor.php?paginas=venta';}, 2000);</script>";
