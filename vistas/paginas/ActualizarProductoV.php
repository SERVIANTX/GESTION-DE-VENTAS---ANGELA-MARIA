                ...
                <tbody>
                    <?php foreach ($Producto as $indice => $valor) : ?>
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="incioAlmacenero.php?paginas=ActualizarProductoV&id=<?php echo $valor['IdProducto']; ?>" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a>
                                </div>
...
<?php
            ...
            if ($Actualizarproducto == "ok") {
                echo "<script>
                        ...
                        echo "<script>  setTimeout(function(){window.location='incioAlmacenero.php?paginas=ActualizarProductoV';}, 2000);</script>";
