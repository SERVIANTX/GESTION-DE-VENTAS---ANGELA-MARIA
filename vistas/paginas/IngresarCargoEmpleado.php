...
require_once "../controladores/ControlArrayCargo.php";
require_once "../modelos/ModelInsertCargo.php";
...
<form class="needs-validation" method="POST" novalidate>
  ...
  <div style="background-color: #fffbf4; width:600px;height:280px; margin-left: auto; margin-right:auto;" >
  <p style="font-size:25px;" class="bg-dark text-white text-center">.: Agregar Cargo :.</p>
    <div class=" row">
      <div class="col-sm-2 ">
      </div>
      <div class="col-sm-6 ">
        ...
        <div class="mb-3 position-relative"><label class="form-label" for="formGroupInputSmall"><strong>Cargo Empleado</strong></label>
          <input onKeyUP="this.value=this.value.toUpperCase();" class="form-control " type="text" id="formGroupInputSmall" placeholder="Escribe" name="txtcargo" onkeypress="return sololetras(event)" onpaste="return false" required>
          <!--  -->
    ...
    <div class="row">
      ...
      <div class="col-sm-2">
        ...
        <div class="d-grid gap-2 col-8 mx-auto">
          ...
          <button type="submit" class="btn btn-primary" name="btnGuardarcargoempleado">Guardar</button>
        </div>
        <br>
        <br>
      </div>
...
<?php
$guardarcargo = clsControlArrayCargo::medControlArrayCargo();
if ($guardarcargo == "ok") {
  echo "<script>swal('Felicidades!', 'Datos Agregados', 'success');</script>";
  echo "<script>  setTimeout(function(){window.location='incio.php?paginas=empleado';}, 2000);</script>";
