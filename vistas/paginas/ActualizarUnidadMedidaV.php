                    ...
                    <tbody>
                        <?php foreach ($UM as $indice => $valor) : ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="incioAlmacenero.php?paginas=ActualizarUnidadMedidaV&id=<?php echo $valor['IdUnidadMedida']; ?>" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a>
                                    </div>
...
<?php
            ...
            if ($ActualizarUM == "ok") {
                echo "<script>
                        ...
                        echo "<script>  setTimeout(function(){window.location='incioAlmacenero.php?paginas=ActualizarUnidadMedidaV';}, 2000);</script>";
