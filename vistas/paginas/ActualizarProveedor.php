                    ...
                    <tbody>
                        <?php foreach ($proveedor as $indice => $valor) : ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="incio.php?paginas=ActualizarProveedor&id=<?php echo $valor['IdProveedor']; ?>" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a>
                                    </div>
...
<?php
            ...
            if ($Actualizarproveedor == "ok") {
                echo "<script>
                        ...
                        echo "<script>  setTimeout(function(){window.location='incio.php?paginas=ActualizarProveedor';}, 2000);</script>";
