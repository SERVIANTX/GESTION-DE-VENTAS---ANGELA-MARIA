...
require_once "../modelos/ModelListReporteStock.php";
require_once "../controladores/ControlReporteStock.php";
...
<div style="background-color: #fffbf4;">
            <p style="font-size:25px;" class="bg-dark text-white text-center">.: REPORTE DE STOCK :.</p>
<div class="row">
    ...
    <div class=" col-10 ">
        ...
        <div class="container">
            ...
            <table id="datatablesSimple" class="table table-dark table-striped">
                ...
                <tbody>
                    <?php foreach ($Stock as $indice => $valor): ?>
                    <tr>
    ...
    <div class="col-2 ">
        ...
        <div class="d-grid gap-2 col-8 mx-auto">
            ...
            <a href="paginas/reporteStockpdf.php" target="_blank">
