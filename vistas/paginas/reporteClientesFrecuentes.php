...
require_once "../modelos/ModelListReporteClienteFrecuente.php";
require_once "../controladores/ControlReporteClienteFrecuente.php";
...
<div style="background-color: #fffbf4;">
    <p style="font-size:25px;" class="bg-dark text-white text-center">.: REPORTE DE CLIENTES MAS FRECUENTES :.</p>
    <div class="row">
        ...
        <div class=" col-10 ">
            ...
            <div class="container">
                <?php
                $ClienteFre = clsControlArrayReporteClienteFrecuente::medReporteClienteFrecuente();
                ?>
                ...
                <table id="datatablesSimple" class="table table-dark table-striped">
                    <thead>
                        <tr>
                            <th>IdCliente</th>
                            <th>Cliente</th>
                            <th>Veces_Compradas</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($ClienteFre as $indice => $valor) : ?>
                            <tr>
                                <td><?php echo $valor["IdCliente"]; ?></td>
                                <td><?php echo $valor["NombreC"]; ?></td>
                                <td><?php echo $valor["Comprado"]; ?></td>
        ...
        <div class="col-2 ">
            ...
            <div class="d-grid gap-2 col-8 mx-auto">
                ...
                <a href="paginas/reporteClienteFrecuentepdf.php" target="_blank">
